...
COLUMNS = [
    ...
    ("리뷰", "review_count", 8), ("평점", "rating", 6), ("28일 판매", "sales_28", 10), ("판매 근거", "sales_basis_label", 12), ("일평균", "daily_avg", 8),
    ("전환율(%)", "conversion", 9), ("최근기간 리뷰", "surge_recent", 10), ("직전기간 리뷰", "surge_prior", 10), ("급증 배수", "surge_ratio", 9), ("전 수집 대비 리뷰 증가/일", "review_growth_per_day", 12), ("28일 조회", "views_28", 10), ("28일 매출", "revenue_28", 14),
