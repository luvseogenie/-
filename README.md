...
- **2단계 상세** — 1차 조건을 통과한 상품을 리뷰 많은 순으로 상세 페이지에 들어가
  **"한 달간 N명 이상 구매"** 문구와 **최근 30일 리뷰수**를 확보
...
엑셀 컬럼: 판정 · 상품명 · 카테고리 · 가격 · 누적 리뷰수 · 누적 예상판매량 · 한 달 구매(쿠팡 표시) ·
30일 리뷰수 · 30일 예상판매량 · 30일 예상매출 · 측정 방식 · 신뢰도 · 평점 · 배송 · 상품 ID · 상품 링크 · 최근 수집
