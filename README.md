...
**대시보드 왼쪽 「소싱 기준」 버튼은 30일 예상 판매량 기준입니다.** 구매 문구는 「상품 조건」 맨 아래
"한 달 구매 (쿠팡 표시)"에 하한을 적으면 2차 필터로 씁니다.

| 버튼 | 조건 (배수 20 기준) |
|---|---|
| 월 500개 이상 | `30일 예상 판매량 ≥ 500` = 30일 리뷰 25건 |
| 월 1,000개 이상 | `30일 예상 판매량 ≥ 1,000` = 30일 리뷰 50건 |
| 월 3,000개 이상 | `30일 예상 판매량 ≥ 3,000` = 30일 리뷰 150건 |
